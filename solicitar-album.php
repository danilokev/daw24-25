...
?>
  <main>
    ...
    <div class="container-text-impreso">
      ...
      <p class="text-album-impreso">Podrás personalizar tu álbum con un título, texto adicional, y elegir
        entre varias opciones de configuración como el color de la portada, el número de copias, y la
        resolución de las fotos.</p>
      <p class="text-album-impreso">También podrás seleccionar la fecha aproximada de recepción y si deseas
        la impresión en color o en blanco y negro. Una vez completado, haz clic en "Solicitar álbum" para
        enviar tu solicitud.</p>
    </div>
